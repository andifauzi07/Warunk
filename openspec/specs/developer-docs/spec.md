...
Menyediakan dokumentasi onboarding developer (`docs/`) yang melengkapi README dan OpenSpec spec: folder terstruktur, diagram alur (Mermaid), referensi skema DB, dan indeks ADR yang men-link ke archive. Dokumentasi ini bukan pengganti spesifikasi perilaku fitur, melainkan panduan cara bekerja di codebase.
